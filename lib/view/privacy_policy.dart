  ...
  var data = [
    {
      ...
      "description":
          "Mountain Kidz & Daycare operates the ‘Mountain Kidz & Daycare’ app (both in Google Play Store and Apple App Store) and its website www.Mountain Kidz & Daycare.com . This page is used to inform users who have decided to use our app regarding policies with the collection, use and disclosure of Personal Information. If you choose to use our App 'Mountain Kidz & Daycare', then you agree to the collection and use of information as mentioned in this policy. The personal information that our app collects are solely used for providing service to its users. The information collected will not be used or shared with any party except as described in this policy.",
    },
    {
